    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (input == 1) {
                ...
                for (Gamestate G: Game){
                    System.out.print("What Game would you like to delete(Enter the name)");
                    for(int i = 0; i < Game.size(); i += 1) {
                        System.out.print("\n"+G.title);
                    }
                    System.out.print("\n>");
                    String Del_input = myscanner.nextLine();
                    if (Del_input.equals(G.title)){
                        if (Game.size() == 0) {
                            System.out.println("You have no contacts!");
                        } else {
                            Game.removeIf(Gamestate -> Del_input.equalsIgnoreCase(G.title));
                        }
                    }
                }
            }
